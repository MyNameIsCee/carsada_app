  ...
  Future<void> _calculateValidRoutesAndNavigate(String query) async {
    ...
    if (validRoutes.isNotEmpty) {
      ...
      if (selectedRoute != null) {
        ...
        _isSelectingSuggestion = true; // Prevent search from re-triggering
        _destinationController.clear(); // Clear the search field
        _suggestions = []; // Ensure suggestions are cleared
      } else {
        setState(() {
