        ...
        children: [
          ...
          Container(
            ...
            child: NavigationBar(
              ...
              height: 60,
              elevation: 0,
              selectedIndex: _isExpanded ? 1 : (controller.selectedIndex.value == 1 ? 2 : controller.selectedIndex.value),
    ...
    return Obx(
      () => Stack(
        children: [
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      _statusMessage,
                      style: TextStyle(
                        color: _isLoading ? Colors.grey : Color(0xFF353232),
          ...
          //cancel route button / fixed position
          Obx(
                ...
                ? Positioned(
                    ...
                    child: Container(
                      ...
                      child: IconButton(
                        onPressed: () {
                          navController.clearRoute();
                          if (widget.onClearFilteredRoutes != null) {
                            widget.onClearFilteredRoutes!(); // here 
                          }
                        },
